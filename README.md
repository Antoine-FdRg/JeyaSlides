...
1. Installer les dépendances du projet : `npm i`
...
Un script est fourni pour automatiser la génération d’un fichier HTML à partir d’un fichier .sml et lancer directement
le serveur Reveal.js (compatible avec Linux, macOS & Git Bash).
...
Le fichier `demo/scripts/FINAL.sml` est une présentation complète qui regroupe **toutes les fonctionnalités** du DSL
JeyaSlides :

- Styles et positionnement d'éléments
- Animations et transitions
- Code visualisé et animé
- Équations complexes
- Graphiques (plots)
- Quiz interactifs
- Médias (images, vidéos)

**Pour lancer la présentation finale :**

Depuis le dossier `scripts`, exécuter :
...
```
cd .\demo
node ..\bin\cli generate .\scripts\FINAL.sml
cd .\presentationexecutor
npm start ./generated/FINAL.html
```
